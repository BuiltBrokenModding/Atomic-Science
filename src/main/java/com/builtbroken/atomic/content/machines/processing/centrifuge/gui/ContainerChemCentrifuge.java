...
public class ContainerChemCentrifuge extends ContainerBase<TileEntityChemCentrifuge>
{
    ...
    {
        super(player, tile);
        addSlotToContainer(new MachineSlot(tile, TileEntityChemCentrifuge.SLOT_FLUID_INPUT, 25, 52).setColor(WrenchColor.BLUE.getColor()));
        addSlotToContainer(new MachineSlot(tile, TileEntityChemCentrifuge.SLOT_FLUID_OUTPUT, 136, 52).setColor(WrenchColor.GREEN.getColor()));
        ...
        int x = 50;
        addSlotToContainer(new MachineSlot(tile, TileEntityChemCentrifuge.SLOT_BATTERY, x, 52).setColor(WrenchColor.PURPLE.getColor()));
