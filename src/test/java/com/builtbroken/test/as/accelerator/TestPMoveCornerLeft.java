...
public class TestPMoveCornerLeft extends PMoveCommon
{
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.EAST, AcceleratorConnectionType.CORNER_LEFT);
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.SOUTH, AcceleratorConnectionType.CORNER_LEFT);
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.WEST, AcceleratorConnectionType.CORNER_LEFT);
