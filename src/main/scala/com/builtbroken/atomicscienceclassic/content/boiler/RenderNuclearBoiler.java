...
{
    public static final TechneModel MODEL = (TechneModel) AdvancedModelLoader.loadModel(new ResourceLocation(Atomic.MODEL_DIRECTORY + "nuclearBoiler.tcn"));
    public static final ResourceLocation TEXTURE = new ResourceLocation(Atomic.DOMAIN, Atomic.MODEL_PATH + "nuclearBoiler.png");
