 ...
 */
public class TestPMoveJoin extends PMoveCommon
{

    @Test //Test move forward from center
    public void northFacingForward()
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.NORTH, TubeConnectionType.JOIN);
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.EAST, TubeConnectionType.JOIN);
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.SOUTH, TubeConnectionType.JOIN);
    ...
    {
        final AcceleratorParticle particle = newParticleInTube(EnumFacing.WEST, TubeConnectionType.JOIN);
