 ...
 */
public class RecipeChemExtractor extends ProcessingRecipe<TileEntityChemBoiler>
{
    ...
    public RecipeChemExtractor(Object input, ItemStack output, FluidStack inputTankBlue, FluidStack outputTankGreen, FluidStack outputTankYellow)
    {
        this.input = input;
        this.output = output;
