...
public class RecipesHazmatArmorDyes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    @Override
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i)
        {
            ...
            if (!itemstack1.isEmpty())
            {
                if (itemstack1.getItem() instanceof ItemArmor)
                {
                    ...
                    if (itemarmor.getArmorMaterial() != ASItems.hazmatArmorMaterialColor || !itemstack.isEmpty())
                    {
                        return false;
                    }
