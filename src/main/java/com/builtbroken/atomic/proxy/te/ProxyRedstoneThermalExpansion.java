package com.builtbroken.atomic.proxy.te;
 ...
 * Created by Dark(DarkGuardsman, Robert) on 6/1/2018.
 */
public class ProxyRedstoneThermalExpansion extends ModProxy
{
    public ProxyRedstoneThermalExpansion()
    {
        super("ThermalExpansion-Compatibility", "ThermalExpansion");
    }
